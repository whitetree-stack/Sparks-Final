...
## Framerate cap ####################################################################
define config.framerate = 60   # or None to uncap again
...
define config.name = _("Sparks of the Beacon")
...
define build.name = "SparksoftheBeacon"
...
define config.save_directory = "SparksoftheBeacon-1761505987"
