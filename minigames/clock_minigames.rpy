...
# Highscore
init -100 python:
    if not hasattr(persistent, "highscore") or persistent.highscore is None:
...
screen draw_tetris():
    frame xysize 750,940 align .5,.5:
        ...
        vbox align vboxalign xsize 140:
            ...
            $ persistent.highscore = persistent.highscore if hasattr(persistent, "highscore") and persistent.highscore is not None else []
